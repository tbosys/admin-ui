...
export default function IntegerType(props) {
  ...
  function onChange(key, type) {
    return e => {
      ...
      props.setState({ ...props.state, type: "integer", [key]: value });
    };
  }
  ...
  return (
    <form className={classes.container} noValidate autoComplete="off">
      ...
      <div>
        <TextField
          InputLabelProps={{ shrink: true }}
          onChange={onChange("default", "integer")}
          className={classes.textField}
          label="default"
          type="number"
      ...
      <div>
        <TextField
          InputLabelProps={{ shrink: true }}
          onChange={onChange("length", "integer")}
          className={classes.textField}
